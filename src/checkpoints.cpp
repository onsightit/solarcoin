...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        boost::assign::map_list_of
            ...
            (543210, uint256("0x46980e38cf574516a299c1f62a7bfdac13e8644b4af921578d246fcea4faf3bf"))
            (683052, uint256("0x42603f6376d36e89e9924bb5f3d0d3abcb0e8576a7e0025eda0174d57b975929"))
            (737145, uint256("0x437c7025ceb553768f6ec4209bbeb557ebe7beeb60c5988c891d0aab6e993f05"))
    ;
    ...
    bool IsMatureSyncCheckpoint()
    {
        ...
        assert(mapBlockIndex.count(hashSyncCheckpoint));
        const CBlockIndex* pindexSync = mapBlockIndex[hashSyncCheckpoint];
        int nMature = (pindexSync->nHeight <= LAST_POW_BLOCK ? nCoinbaseMaturity_PoW : nCoinbaseMaturity);
