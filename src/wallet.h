...
enum WalletFeature
{
    ...
    FEATURE_LATEST = 60001 // PoST requiers an upgrade
};
...
public:
    ...
    bool CreateCoinStakeTime(const CKeyStore& keystore, unsigned int nBits, int64_t nSearchInterval, int64_t nFees, CTransaction& txNew, CKey& key);
