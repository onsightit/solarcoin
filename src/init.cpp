...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/onsightit/solarcoin>";
    const std::string URL_WEBSITE = "<https://solarcoin.org>";
...
bool AppInitParameterInteraction()
{
    ...
    if (gArgs.IsArgSet("-debug")) {
        fDebug = gArgs.GetBoolArg("-debug", false); // legacy flag
