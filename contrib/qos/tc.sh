...
iptables -t mangle -A OUTPUT -p tcp -m tcp --dport 18188 ! -d ${LOCALNET_V4} -j MARK --set-mark 0x2
iptables -t mangle -A OUTPUT -p tcp -m tcp --sport 18188 ! -d ${LOCALNET_V4} -j MARK --set-mark 0x2
